...
Use Devextreme components when developing components like button, data grid, charts, dropdowns etc.
...
- **Using Bootstrap CSS with Angular**: Integrating Bootstrap CSS into Angular projects. Read [bootstrap.md](references/bootstrap.md)
